...
In this finite deformation example, the single-stage approach \cite{Oliver.etal:2010} cannot correctly detect the bifurcation time nor the bifurcation direction. 
